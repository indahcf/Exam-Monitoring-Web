            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('/admin/jadwal_ujian/update/' . $jadwal_ujian['id_jadwal_ujian']); ?>" method="post" class="forms-sample" id="form-edit">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control <?= (validation_show_error('waktu_ujian')) ? 'is-invalid' : ''; ?>" id="waktu_ujian" name="waktu_ujian" value="<?= old('waktu_ujian', $jadwal_ujian['waktu_ujian']); ?>" placeholder="Waktu Ujian">
                        <div class="invalid-feedback">
