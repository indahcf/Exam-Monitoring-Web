                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control <?= (validation_show_error('koordinator_ujian')) ? 'is-invalid' : ''; ?>" id="koordinator_ujian" name="koordinator_ujian">
                            ...
                            <?php foreach ($koordinator_ujian as $k) : ?>
                                <option value="<?= $k['id_dosen']; ?>" <?= (old('koordinator_ujian', $jadwal_ujian['koordinator_ujian']) == $k['id_dosen']) ? 'selected' : '' ?>>
                                    <?= $k['dosen']; ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                ...
                <script>
                    ...
                    function getRuanganTersedia() {
                        ...
                        if (tanggal != null && jam_mulai != null && jam_selesai != null && id_jadwal_ujian != null) {
                            ...
                            $.ajax({
                                url: "<?= base_url(); ?>" + '/api/ruang_ujian?tanggal=' + tanggal + '&jam_mulai=' + jam_mulai + '&jam_selesai=' + jam_selesai + '&id_jadwal_ujian=' + id_jadwal_ujian,
                                type: 'GET',
                                success: function(response) {
                    ...
                    function getPengawasTersedia() {
                        ...
                        if (tanggal != null && jam_mulai != null && jam_selesai != null) {
                            ...
                            console.log('jam selesai', jam_selesai)
                            $.ajax({
                                url: "<?= base_url(); ?>" + '/api/pengawas?tanggal=' + tanggal + '&jam_mulai=' + jam_mulai + '&jam_selesai=' + jam_selesai + '&id_jadwal_ujian=' + id_jadwal_ujian,
                                type: 'GET',
                                success: function(response) {
