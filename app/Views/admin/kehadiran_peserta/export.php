        ...
        <table width="100%" class="surat">
            <tr>
                <td class="tengah">
                    ...
                    <p>Alamat: Jl. Mayjen Sungkono km 5 Blater, Kalimanah, Purbalingga 53371</p>
                    <p>Telepon/Faks : (0281) 6596801, 6596700</p>
                </td>
            </tr>
        </table>
    </div>
    <div class="laporan">
        <h3 style="margin-bottom: 5px;"><u>BERITA ACARA UJIAN</u></h3>
        <?php echo $label ?><br>
