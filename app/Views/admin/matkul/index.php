...
<div class="template-demo">
    <a href="<?= base_url(); ?>admin/matkul/create" class="btn btn-primary btn-icon-text">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($matkul as $m) : ?>
                                <tr>
                                    ...
                                    <td><?= $m['prodi']; ?></td>
                                    <td>
                                        <a href="<?= base_url(); ?>admin/matkul/edit/<?= $m['id_matkul']; ?>" class="btn btn-warning btn-rounded btn-icon">
                                            <i class="ti-pencil"></i>
                                        </a>
