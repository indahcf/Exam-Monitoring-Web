    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <?php if ($kehadiran_pengawas == NULL) { ?>
                    ...
                    <?php } else { ?>
                        <form action="<?= base_url('/admin/kehadiran_pengawas/update/' . $kehadiran_pengawas['id_kehadiran_pengawas']); ?>" method="post" class="forms-sample" id="form-edit">
                        <?php } ?>
                        <?= csrf_field(); ?>
