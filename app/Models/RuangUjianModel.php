...
class RuangUjianModel extends Model
{
    ...
    // {
    //     $ruang_ada = $this->db->table('jadwal_ruang')->select('jadwal_ruang.id_jadwal_ujian, jadwal_ruang.id_ruang_ujian')->where("jadwal_ruang.id_jadwal_ujian !=", $id_jadwal_ujian)->join('ruang_ujian', 'jadwal_ruang.id_ruang_ujian=ruang_ujian.id_ruang_ujian', 'right')->join('jadwal_ujian', 'jadwal_ruang.id_jadwal_ujian=jadwal_ujian.id_jadwal_ujian', 'left')->where('tanggal = "' . $tanggal . '" AND ("' . $jam_mulai . '" BETWEEN jam_mulai AND jam_selesai OR "' . $jam_selesai . '" BETWEEN jam_mulai AND jam_selesai OR ("' . $jam_mulai . '" <= jam_mulai AND "' . $jam_selesai . '" >= jam_selesai))');
    //     // dd($ruang_ada);
